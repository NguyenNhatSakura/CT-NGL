...
#!/usr/bin/env python
# coding: utf-8
# Telegram: @ct_nguyennhatit
# Version: 1.2
# Github: https://github.com/nguyennhatsakura
# Description: I Love CamTu<3
# ==================================
...
class CT_NGL:
    def __init__(self,
        ...
        self._timeout = 15
        self.NAME_TOOL = "CT-NGL Tool"
        self.VERSION_TOOL = "v1.1"
        if os.name == "nt":
            os.system(
    ...
    def _input(self):
        ...
        while True:
            try:
                ...
                if self._threads < 1 or self._threads > 5000:
                    print(
...
\033[0;31m[+] Telegram: @ct_nguyennhatit""")
        print("".join([
